 ...
 * Ryan,Silas,Risto
 * 1/27/22
 * Caterpie class to represent caterpie and will be given a name and a set of its own damage when the abilities are given
...
public class Caterpie extends AbstractPokemon{
     ...
     */
    public Caterpie(String pName,double pHealth, String pAbility1, String pAbility2, String pAbility3, String pAbility4){
   ...
   /**
     ...
     * @return 
     */
    public boolean equals(Caterpie other){
    ...
    public Pokemon clone(){
        Caterpie clone = new Caterpie(name,health,ability1,ability2,ability3,ability4);
        return clone;
    }
    /**
    ...
    public void ability1(Pokemon other){
        double attack = (Math.random()*2)+8;
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Dark") || other.getType2().equals("Dark") || other.getType().equals("Grass")||other.getType2().equals("Grass")){
            other.setHealth(other.health() - attack);
        }   
    }
    /**
    ...
    public void ability3(Pokemon other){
        double attack = (Math.random()*10)+6;
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Dark") || other.getType2().equals("Dark") || other.getType().equals("Grass")||other.getType2().equals("Grass")){
            other.setHealth(other.health() - attack);
        }
    ...
    public void ability4(Pokemon other){
        ...
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Flying") || other.getType2().equals("Flying") || other.getType().equals("Water")||other.getType2().equals("Water")){
            other.setHealth(other.health() - attack);
        } 
    }
    /**
    ...
    public ImageIcon display(){
        ImageIcon pokemon = new ImageIcon("src/caterpieRight.png");
        return pokemon;
    }
