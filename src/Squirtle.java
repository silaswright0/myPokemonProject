 ...
 * Ryan,Silas,Risto
 * 1/27/22
 * Squirtle class to represent squirtle and will be given a name and a set of its own damage when the abilities are given
...
public class Squirtle extends AbstractPokemon{
     ...
     * @param pAbility1 //the first ability of pokemon
     * @param pAbility2 //the second ability of pokemon
     * @param pAbility3 //the third ability of pokemon
     * @param pAbility4 //the fourth ability of pokemon
     */
    public Squirtle(String pName,double pHealth, String pAbility1, String pAbility2, String pAbility3, String pAbility4){
        super(pName, pHealth, pAbility1, pAbility2, pAbility3, pAbility4);//calls superclasses contructor
    }
    /**
   ...
   /**
     ...
     * @return 
     */
    public boolean equals(Squirtle other){
    ...
    public Pokemon clone(){
        Squirtle clone = new Squirtle(name,health,ability1,ability2,ability3,ability4);
        return clone;
    }
    /**
    ...
    public void ability3(Pokemon other){
        double attack = (Math.random()*6)+6;
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Rock") || other.getType2().equals("Rock") || other.getType().equals("Ground")||other.getType2().equals("Ground") || other.getType().equals("Fire") || other.getType2().equals("Fire")){
            other.setHealth(other.health() - attack);
        }
    }
    /**
    ...
    public ImageIcon display(){
        ImageIcon pokemon = new ImageIcon("src/SquirtleRight.png");
        return pokemon;
    }
}
