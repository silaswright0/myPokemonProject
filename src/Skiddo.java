 ...
 * Ryan,Silas,Risto
 * 1/27/22
 * Skiddo class to represent Skiddo and will be given a name and a set of its own damage when the abilities are given
...
public class Skiddo extends AbstractPokemon{
     ...
     */
    public Skiddo(String pName,double pHealth, String pAbility1, String pAbility2, String pAbility3, String pAbility4){
        super(pName, pHealth, pAbility1, pAbility2, pAbility3, pAbility4);//call superclasses constructor
    }
    /**
   ...
   /**
    ...
    public Pokemon clone(){
        Skiddo clone = new Skiddo(name,health,ability1,ability2,ability3,ability4);
        return clone;
    }
    /**
    ...
    public ImageIcon display(){
        ImageIcon pokemon = new ImageIcon("src/skiddoRight.png");
        return pokemon;
    }
}
