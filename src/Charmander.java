 ...
 * Ryan,Silas,Risto
 * 1/27/22
 * Charmander class to represent charmander and will be given a name and a set of its own damage when the abilities are given
...
public class Charmander extends AbstractPokemon{
     ...
     */
    public Charmander(String pName,double pHealth, String pAbility1, String pAbility2, String pAbility3, String pAbility4){
        super(pName, pHealth, pAbility1, pAbility2, pAbility3, pAbility4);//calls the superclasses constructor
    }
   ...
   /**
     ...
     * @return 
     */
    public boolean equals(Charmander other){
    ...
    public Pokemon clone(){
        Charmander clone = new Charmander(name,health,ability1,ability2,ability3,ability4);
        return clone;
    }
    /**
    ...
    public ImageIcon display(){
        ImageIcon pokemon = new ImageIcon("src/CharRight.png");
        return pokemon;
    }
}
