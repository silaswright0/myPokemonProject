 ...
 * Ryan,Silas,Risto
 * 1/27/22
 * Geodude class to represent geodude and will be given a name and a set of its own damage when the abilities are given
...
public class Geodude extends AbstractPokemon{
     ...
     */
    public Geodude (String pName,double pHealth, String pAbility1, String pAbility2, String pAbility3, String pAbility4){
   ...
   /**
     ...
     * @return 
     */
    public boolean equals(Geodude other){
    ...
    public Pokemon clone(){
        Geodude clone = new Geodude(name,health,ability1,ability2,ability3,ability4);
        return clone;
    }
    /**
    ...
    public void ability2(Pokemon other){
        double attack = (Math.random()*8)+8;
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Bug") || other.getType2().equals("Bug") || other.getType().equals("Flying")||other.getType2().equals("Flying") || other.getType().equals("Fire") || other.getType2().equals("Fire")){
            other.setHealth(other.health() - attack);
        }
    }
    /**
    ...
    public void ability3(Pokemon other){
        ...
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Rock") || other.getType2().equals("Rock") || other.getType().equals("Fire")||other.getType2().equals("Fire")){
            other.setHealth(other.health() - attack);
        } 
    }
    /**
    ...
    public ImageIcon display(){
        ImageIcon pokemon = new ImageIcon("src/geoRight.png");
        return pokemon;
    }
}
