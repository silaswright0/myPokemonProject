 ...
 * Ryan,Silas,Risto
 * 1/27/22
 * Gible class to represent gible and will be given a name and a set of its own damage when the abilities are given
...
public class Gible extends AbstractPokemon{
     ...
     */
    public Gible(String pName,double pHealth, String pAbility1, String pAbility2, String pAbility3, String pAbility4){
   ...
   /**
     ...
     * @return 
     */
    public boolean equals(Gible other){
    ...
    public Pokemon clone(){
        Gible clone = new Gible(name,health,ability1,ability2,ability3,ability4);
        return clone;
    }
    /**
    ...
    public void ability3(Pokemon other){
        ...
        other.setHealth(other.health() - attack);
        if(other.getType().equals("Dragon") || other.getType2().equals("Dragon")){
            other.setHealth(other.health() - attack);
        }
    }
    /**
    ...
    public ImageIcon display(){
        ImageIcon pokemon = new ImageIcon("src/gibleRight.png");
        return pokemon;
    }
}
